...
alter table buyers add column if not exists department text not null default '';
alter table buyers add column if not exists category_scope text not null default '';
alter table buyers add column if not exists subcategory_scope text not null default '';
alter table buyers add column if not exists buyer_role text not null default 'UNCONFIRMED';
alter table buyers add column if not exists identity_confidence integer not null default 0;
alter table buyers add column if not exists category_confidence integer not null default 0;
alter table buyers add column if not exists category_evidence_url text not null default '';
