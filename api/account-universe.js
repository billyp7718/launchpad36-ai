...
export default async function handler(req,res){
  ...
  try{const rows=await sql`
    ...
    left join lateral (
      ...
      json_agg(json_build_object('id',b.id,'name',b.name,'title',b.title,'category',b.category,'department',b.department,'category_scope',b.category_scope,'subcategory_scope',b.subcategory_scope,'buyer_role',b.buyer_role,'email',b.email,'phone',b.phone,'linkedin',b.linkedin,'source_url',b.source_url,'confidence',b.confidence,'identity_confidence',b.identity_confidence,'category_confidence',b.category_confidence,'verification_status',b.verification_status,'employment_verification_status',b.employment_verification_status,'employment_evidence_url',b.employment_evidence_url,'employment_last_verified',b.employment_last_verified,'category_verification_status',b.category_verification_status,'category_evidence_url',b.category_evidence_url,'category_evidence_source',b.category_evidence_source,'category_last_verified',b.category_last_verified,'relationship_review_reason',b.relationship_review_reason,'replacement_search_required',b.replacement_search_required,'updated_at',b.updated_at) order by (b.category_verification_status='VERIFIED') desc,b.category_confidence desc,b.identity_confidence desc,b.updated_at desc) buyers
