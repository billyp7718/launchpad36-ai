...
export default function handler(req,res){
  try{
    ...
    const deepBuyerUiV3=fs.readFileSync(deepBuyerUiV3Path,'utf8');
    html=html.replace('</body>',`<script>${channelUi}</script><script>${buyerUi}</script><script>${workflowUi}</script><script>${buyerCoverageUi}</script><script>${routeFitUi}</script><script>${buyerRetryUi}</script><script>${deepBuyerUi}</script><script>${deepBuyerUiV2}</script><script>${deepBuyerUiV3}</script></body>`);
