...
export default async function handler(req,res){
  ...
  try{
    ...
    return res.status(200).json({approved:true,already_verified:false,evidence_id:result.evidence.id,verification_status:result.verification_status,deterministic_update_applied:result.deterministic_update_applied});
