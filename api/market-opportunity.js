...
function retainAccountEdits(nextScenario,previousScenario={}){
  ...
  if(!proposed&&!previousAdjustment&&!previousScenario.assigned_buyer)return nextScenario;
